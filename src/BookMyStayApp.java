...
public class BookMyStayApp {
    public static void main(String[] args) {
        ...
        // 3. Simulate existing Reservation IDs (The UC7 Actor Flow)
        String resId1 = "RES-1001";
        String resId2 = "RES-1002";

        System.out.println("Guest selecting services for " + resId1 + "...");
        serviceManager.addServiceToReservation(resId1, wifi);
        serviceManager.addServiceToReservation(resId1, breakfast);

        System.out.println("Guest selecting services for " + resId2 + "...");
        serviceManager.addServiceToReservation(resId2, spa);

        System.out.println("\n--- Final Summary ---");

        // 4. Show results (The UC7 Flow)
        serviceManager.displayServices(resId1);
        System.out.println("Total Additional Cost for " + resId1 + ": $" + serviceManager.calculateTotalServiceCost(resId1));

        System.out.println();

        serviceManager.displayServices(resId2);
        System.out.println("Total Additional Cost for " + resId2 + ": $" + serviceManager.calculateTotalServiceCost(resId2));
